...
const VendorSchema = new mongoose.Schema(
  {
    ...
    flaggedReason: { type: String, trim: true, maxlength: 500, default: null },
    isTerminated: { type: Boolean, default: false, index: true },
    terminatedAt: { type: Date, default: null },
    terminatedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null },
    terminationReason: { type: String, trim: true, maxlength: 500, default: null },
